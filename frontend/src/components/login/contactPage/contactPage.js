    ...
    return (
        <div className="contactComponent">
            <div className='formComponent'>
                ...
                <div className='field'>
                    <input className='inputFieldStyle' type="text" onChange={(e)=>setName(e.target.value)} placeholder='Name'></input>
                    {
                        errors.nameError && <p className='errorField'>{errors.nameError}</p>
                    }
                </div>
                <div className='field'>
                    <input className='inputFieldStyle' type="email" onChange={(e)=>setEmail(e.target.value)} placeholder='Email'></input>
                    {
                        errors.nameError && <p className='errorField'>{errors.nameError}</p>
                    }
                </div>
                <div className='field'>
                    <textarea className='textareaStyle' onChange={(e)=>setQuery(e.target.value)} placeholder='Query'></textarea>
                    {
                        errors.nameError && <p className='errorField'>{errors.nameError}</p>
                    }
                </div>
